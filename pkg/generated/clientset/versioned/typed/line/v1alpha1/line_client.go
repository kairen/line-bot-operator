...
import (
	...
	"github.com/kubedev/line-bot-operator/pkg/generated/clientset/versioned/scheme"
	serializer "k8s.io/apimachinery/pkg/runtime/serializer"
	rest "k8s.io/client-go/rest"
)

type LineV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*LineV1alpha1Client, error) {
	...
	return &LineV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new LineV1alpha1Client for the given config and
