	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LineV1alpha1().EventBindings(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LineV1alpha1().EventBindings(namespace).Watch(options)
			},
		},
		&linev1alpha1.EventBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *eventBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&linev1alpha1.EventBinding{}, f.defaultInformer)
}
